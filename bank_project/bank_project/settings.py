...
SECRET_KEY = 'django-insecure-a%he1v8!2wd5+__j&s3xkvb#0*d9=9@brn62+j)#lz6e++to)m'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'matua.models2003@gmail.com'
EMAIL_HOST_PASSWORD = 'anumwbfjsfqkyzmz'
EMAIL_USE_SSL = False
EMAIL_USE_TLS = True
